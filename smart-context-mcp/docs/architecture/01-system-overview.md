...
Smart Context enables AI agents to **efficiently understand and modify large codebases** through a three-stage pipeline optimized for token constraints and safety.
...
├──────────────────────────────────────────────────┤
│                                                  │
│  1. SCOUT     2. READ        3. EDIT            │
│  Find code    Understand     Modify safely      │
│  (200ms)      (100-300ms)    (100-500ms)       │
│                                                  │
